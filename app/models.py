...
# engine = DB.create_engine(sa_url=postgres_url, engine_opts={})

# *** DATA IMPORT/MIGRATION FUNCTIONS ***

# COMMENT OUT FOR DEPLOYMENT TO HEROKU
def csv_to_postgres(engine, file: str, table_name: str):
    """
...
def import_and_clean_data(input_feature_list):
    ...
    # Import test data
    path = r"data/Kickstarter_Data_For_Model_10k.csv"
    df = pd.read_csv(path)
...
def process_record(input_feature_list):
    ...
    path = r"data/pickle_model_10k.pkl"
